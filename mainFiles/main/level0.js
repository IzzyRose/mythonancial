 ...
 function startLevel() {
     ...
     setTimeout(function () {
         $("div.mText").html("Hello! I'm Peconia, an investor to be!");
...
function gobossLevel(){
    var $input = $('<input type="button" href="level1.html" id="continueBTN3" class="nextBoss" value="750" />');
    $input.appendTo($("#level1"));
    $(".nextBoss").click(function () {
             console.log("clicked");
              $("#link").click();
         });
}
